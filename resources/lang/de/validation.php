...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines German File
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'prohibited' => 'Das Feld: Attribut ist verboten.',
    ...
    'starts_with' => 'Das Attribut: muss mit einem der folgenden Werte beginnen :: Wertes.',
