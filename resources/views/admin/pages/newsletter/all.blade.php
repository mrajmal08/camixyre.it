  ...
  <div class="row">
    <div class="col-6">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">All Subscribed Emails</li>
      </ol>
    </div>
    <div class="col-6">
            ...
            <tbody class="mb-5">
                @if($newsletters)
                    ...
                    <tr>
                        ...
                        <td>
                          <button onclick="showSwal('passing-parameter-execute-cancel', {{$newsletter->id}})" type="button" class="btn btn-danger btn-icon">
                            <i data-feather="trash-2"></i>
                          </button>
                          <form id="delete-newsletter-{{$newsletter->id}}" action="{{route('newsletter.destroy', $newsletter->id)}}" method="POST">
                            @csrf
                            {{ method_field('DELETE') }}
                          </form>
                        </td>
            ...
            if (result.value) {
              swalWithBootstrapButtons.fire(
                ...
                'success'
                  ...
                  var elementID = "delete-newsletter-" + id;
