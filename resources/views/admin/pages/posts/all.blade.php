            ...
            <tbody class="mb-5">
                @if($posts)
                    ...
                    <tr>
                        ...
                        <td>
                          <button onclick="window.location='{{route('post.edit', $post->id)}}'" type="button" class="btn btn-primary btn-icon">
                            <i data-feather="edit-3"></i>
                          </button>
                          <button onclick="showSwal('passing-parameter-execute-cancel', {{$post->id}})" type="button" class="btn btn-danger btn-icon">
