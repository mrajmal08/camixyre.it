        ...
        <div class="tab-content mt-3" id="lineTabContent">
          ...
          <div class="tab-pane fade show active" id="english-product" role="tabpanel" aria-labelledby="english-tab">
            <fieldset class="row">
              <div class="form-group col-md-6">
                ...
                <input class="form-control" name="title-en" type="text" value="{{ $product->title_en }}" required>
              </div>
              <div class="form-group col-md-6">
                <label for="meta title">Meta Title</label>
                <input class="form-control" name="meta-title-en" value="{{ $product->meta_title_en }}" type="text">
              </div>
              <div class="form-group col-12">
                <label for="description">Product Description</label>
                <textarea class="form-control" name="description-en" id="tinymceEn" rows="10">{!! $product->description_en !!}</textarea>
              </div>
              <div class="form-group col-md-6">
                <label for="meta keyword">Meta Keyword</label>
                <input class="form-control" name="meta-keyword-en" value="{{ $product->meta_keyword_en }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta description">Meta Description</label>
                <input class="form-control" name="meta-description-en" value="{{ $product->meta_description_en }}" type="text">
              </div>
              <div class="form-group col-6">
                <label for="description">Short Description</label>
                <textarea class="form-control" name="short-description-en" rows="10">{!! $product->short_description_en !!}</textarea>
              </div>
              <div class="form-group col-6">
                <label for="description">Shipping & Delivery</label>
                <textarea class="form-control" name="shipping-delivery-en" rows="10">{!! $product->shipping_delivery_en !!}</textarea>
              </div>
              <div class="form-group col-12">
                <label for="tags">Tags</label>
                <input name="tags" id="tags-en" value="{{ $product->tags_en }}">
              </div>
            </fieldset>
          </div>
          ...
          <div class="tab-pane fade" id="italian-product" role="tabpanel" aria-labelledby="italian-tab">
            <fieldset class="row">
              <div class="form-group col-md-6">
                <label for="product title">Product Title</label>
                <input class="form-control" name="title-it" value="{{ $product->title_it }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta title">Meta Title</label>
                <input class="form-control" name="meta-title-it" value="{{ $product->meta_title_it }}" type="text">
              </div>
              <div class="form-group col-12">
                <label for="description">Product Description</label>
                <textarea class="form-control" name="description-it" id="tinymceIt" rows="10">{!! $product->description_it !!}</textarea>
              </div>
              <div class="form-group col-md-6">
                <label for="meta keyword">Meta Keyword</label>
                <input class="form-control" name="meta-keyword-it" value="{{ $product->meta_title_it }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta description">Meta Description</label>
                <input class="form-control" name="meta-description-it" value="{{ $product->meta_description_it }}" type="text">
              </div>
              <div class="form-group col-6">
                <label for="description">Short Description</label>
                <textarea class="form-control" name="short-description-it" rows="10">{!! $product->short_description_it !!}</textarea>
              </div>
              <div class="form-group col-6">
                <label for="description">Shipping & Delivery</label>
                <textarea class="form-control" name="shipping-delivery-it" rows="10">{!! $product->shipping_delivery_it !!}</textarea>
              </div>
              <div class="form-group col-12">
                <label for="tags">Tags</label>
                <input name="tags" id="tags-it" value="{{ $product->tags_it }}" value="">
              </div>
            </fieldset>
          </div>
          ...
          <div class="tab-pane fade" id="french-product" role="tabpanel" aria-labelledby="french-tab">
            <fieldset class="row">
              <div class="form-group col-md-6">
                <label for="product title">Product Title</label>
                <input class="form-control" name="title-fr" value="{{ $product->title_fr }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta title">Meta Title</label>
                <input class="form-control" name="meta-title-fr" value="{{ $product->meta_title_fr }}" type="text">
              </div>
              <div class="form-group col-12">
                <label for="description">Product Description</label>
                <textarea class="form-control" name="description-fr" id="tinymceFr" rows="10">{!! $product->description_fr !!}</textarea>
              </div>
              <div class="form-group col-md-6">
                <label for="meta keyword">Meta Keyword</label>
                <input class="form-control" name="meta-keyword-fr" value="{{ $product->meta_keyword_fr }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta description">Meta Description</label>
                <input class="form-control" name="meta-description-fr" value="{{ $product->meta_description_fr }}" type="text">
              </div>
              <div class="form-group col-6">
                <label for="description">Short Description</label>
                <textarea class="form-control" name="short-description-fr" rows="10">{!! $product->short_description_fr !!}</textarea>
              </div>
              <div class="form-group col-6">
                <label for="description">Shipping & Delivery</label>
                <textarea class="form-control" name="shipping-delivery-fr" rows="10">{!! $product->shipping_delivery_fr !!}</textarea>
              </div>
              <div class="form-group col-12">
                <label for="tags">Tags</label>
                <input name="tags" id="tags-fr" value="{{ $product->tags_fr }}">
              </div>
            </fieldset>
          </div>
          ...
          <div class="tab-pane fade" id="spanish-product" role="tabpanel" aria-labelledby="spanish-tab">
            <fieldset class="row">
              <div class="form-group col-md-6">
                <label for="product title">Product Title</label>
                <input class="form-control" name="title-es" value="{{ $product->title_es }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta title">Meta Title</label>
                <input class="form-control" name="meta-title-es" value="{{ $product->meta_title_es }}" type="text">
              </div>
              <div class="form-group col-12">
                <label for="description">Product Description</label>
                <textarea class="form-control" name="description-es" id="tinymceEs" rows="10">{!! $product->description_es !!}</textarea>
              </div>
              <div class="form-group col-md-6">
                <label for="meta keyword">Meta Keyword</label>
                <input class="form-control" name="meta-keyword-es" value="{{ $product->meta_keyword_es }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta description">Meta Description</label>
                <input class="form-control" name="meta-description-es" value="{{ $product->meta_description_es }}" type="text">
              </div>
              <div class="form-group col-6">
                <label for="description">Short Description</label>
                <textarea class="form-control" name="short-description-es" rows="10">{!! $product->short_description_es !!}</textarea>
              </div>
              <div class="form-group col-6">
                <label for="description">Shipping & Delivery</label>
                <textarea class="form-control" name="shipping-delivery-es" rows="10">{!! $product->shipping_delivery_es !!}</textarea>
              </div>
              <div class="form-group col-12">
                <label for="tags">Tags</label>
                <input name="tags" id="tags-es" value="{{ $product->tags_es }}">
              </div>
            </fieldset>
          </div>
          ...
          <div class="tab-pane fade" id="german-product" role="tabpanel" aria-labelledby="german-tab">
            <fieldset class="row">
              <div class="form-group col-md-6">
                <label for="product title">Product Title</label>
                <input class="form-control" name="title-de" value="{{ $product->title_de }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta title">Meta Title</label>
                <input class="form-control" name="meta-title-de" value="{{ $product->meta_title_de }}" type="text">
              </div>
              <div class="form-group col-12">
                <label for="description">Product Description</label>
                <textarea class="form-control" name="description-de" id="tinymceDe" rows="10">{!! $product->description_de !!}</textarea>
              </div>
              <div class="form-group col-md-6">
                <label for="meta keyword">Meta Keyword</label>
                <input class="form-control" name="meta-keyword-de" value="{{ $product->meta_keyword_de }}" type="text">
              </div>
              <div class="form-group col-md-6">
                <label for="meta description">Meta Description</label>
                <input class="form-control" name="meta-description-de" value="{{ $product->meta_description_de }}" type="text">
              </div>
              <div class="form-group col-6">
                <label for="description">Short Description</label>
                <textarea class="form-control" name="short-description-de" rows="10">{!! $product->short_description_de !!}</textarea>
              </div>
              <div class="form-group col-6">
                <label for="description">Shipping & Delivery</label>
                <textarea class="form-control" name="shipping-delivery-de" rows="10">{!! $product->shipping_delivery_de !!}</textarea>
              </div>
              <div class="form-group col-12">
                <label for="tags">Tags</label>
                <input name="tags" id="tags-de" value="{{ $product->tags_de }}">
              </div>
            </fieldset>
          </div>
        ...
        <div class="col-12 mt-4">
            <fieldset class="row">
              <div class="form-group col-md-6">
                ...
                <input class="form-control" id="url_en" name="url-en" value="{{ $product->url_en }}" type="text" autocomplete="off" required>
              </div>
              <div class="form-group col-md-6">
                <label for="slug">Product Url (Italian)</label>
                <input class="form-control" id="url_it" name="url-it" value="{{ $product->url_it }}" type="text" autocomplete="off" required>
              </div>
              <div class="form-group col-md-6">
                <label for="slug">Product Url (French)</label>
                <input class="form-control" id="url_fr" name="url-fr" value="{{ $product->url_fr }}" type="text" autocomplete="off" required>
              </div>
              <div class="form-group col-md-6">
                <label for="slug">Product Url (Spanish)</label>
                <input class="form-control" id="url_es" name="url-es" value="{{ $product->url_es }}" type="text" autocomplete="off" required>
              </div>
              <div class="form-group col-md-6">
                <label for="slug">Product Url (German)</label>
                <input class="form-control" id="url_de" name="url-de" value="{{ $product->url_de }}" type="text" autocomplete="off" required>
              </div>
      ...
      <div class="example col-12 mt-3">
        ...
        <div id="append-variation" class="row">
          ...
          @if(count($variations) > 0)
            ...
            <div class="col-12 mt-4 p-4" data-variation-id="{{ $variation->variation_id }}" style="background-color: #070d19;">
                <input type="hidden" value="{{ $variation->name }}" name="variation-name[]">
                <input type="hidden" value="{{ $variation->type }}" name="variation-type[]">
                <input type="hidden" value="{{ $variation->key }}" name="variation-key">
                <input type="hidden" value="{{ $variation->variation_id }}" name="variation-id[]">
                
                <div class="row pb-4" style="border-bottom: 1px solid #262f43">
                <div class="col-6 d-flex align-items-center">
                    <h5>{{ $variation->name }} - {{ $variation->type }}</h5>
                </div>
                <div class="col-6 text-right">
                    <button type="button" id="{{ $variation->variation_id }}" class="btn" onclick="removeVariation(this.id)">
                ...
                {{-- Attributes Start --}}
                <div id="append-attribute-{{ $variation->variation_id }}" class="mt-4 mb-4">
                    @foreach ($attributes as $attribute)
                    @if($variation->variation_id == $attribute->variation_box_id)
                    <input type="hidden" value="{{ $variation->key }}" name="attribute-key">
                    <fieldset class="row" data-attributes-id="{{ $attribute->id }}">
                      <input type="hidden" value="{{ $attribute->variation_box_id }}" name="variation-box-id[]">
                      <div class="col-md-3 mb-3">
                        <label for="Attribute Name">Attribute Name English</label>
                        <input type="text" class="form-control" name="attribute-name-en[]" value="{{ $attribute->name_en }}" placeholder="Attribute Name" required>
                      </div>
                      <div class="col-md-3 mb-3">
                        <label for="Attribute Name">Attribute Name Italian</label>
                        <input type="text" class="form-control" name="attribute-name-it[]" value="{{ $attribute->name_it }}" placeholder="Attribute Name">
                      </div>
                      <div class="col-md-3 mb-3">
                        <label for="Attribute Name">Attribute Name French</label>
                        <input type="text" class="form-control" name="attribute-name-fr[]" value="{{ $attribute->name_fr }}" placeholder="Attribute Name">
                      </div>
                      <div class="col-md-3 mb-3">
                        <label for="Attribute Name">Attribute Name Spanish</label>
                        <input type="text" class="form-control" name="attribute-name-es[]" value="{{ $attribute->name_es }}" placeholder="Attribute Name">
                      </div>
                      <div class="col-md-3 mb-3">
                        <label for="Attribute Name">Attribute Name German</label>
                        <input type="text" class="form-control" name="attribute-name-de[]" value="{{ $attribute->name_de }}" placeholder="Attribute Name">
                      </div>
                      <div class="col-md-3 mb-3">
                        <label for="Price">Price</label>
                        <input type="number" name="attribute-price[]" class="form-control text-left" value="{{ $attribute->price }}" placeholder="Price">
                      </div>
                      <div class="col-md-3">
                        <label for="Price Pound">Attribute Images</label>
                        <input type="hidden" data-attribute-src="{{ $attribute->id }}" name="attribute-images[]" value="{{ $attribute->images }}">
                        <button type="button" id="{{ $attribute->id }}" class="btn btn-info btn-block" data-toggle="modal" data-target=".bd-image-modal-x3" onclick="selectAttrImg(this.id)">Change Images</button>
                        {{-- <p data-attribute-counts="{{ $attribute->id }}" class="mt-2 text-secondary">{{ $attribute->images }}</p> --}}
                        @if(empty($attribute->images))
                          <p id="count-multiple" class="mt-2 text-secondary">0 Images Selected</p>
                        @else
                          @php
                            $imagesList = explode("|", $attribute->images);
                            $imagesList = array_filter($imagesList);
                          @endphp
                          @foreach ($imagesList as $image)
                            <img src="/media/{{ $image }}" style="width: 35px; margin: 5px; margin-left: 0;">
                          @endforeach
                        @endif
                      </div>
                      <div class="col-md-2 mb-3">
                        <label for="remove" style="visibility: hidden">.</label>
                        <button type="button" id="{{ $attribute->id }}" class="btn btn-danger btn-block" onclick="removeAttr(this.id)">Remove</button>
                      </div>
                    </fieldset>
                    @endif
                    @endforeach
                ...
                <div class="col-6">
                    <button type="button" id="attribute-{{ $variation->variation_id }}" class="btn btn-primary" onclick="addNewAttribute(this.id)">Add New Attribute</button>
                </div>
                </div>
  ...
  <div class="col-xl-3 main-content pr-xl-4">
    <div class="example">
      <div class="form-group col-md-12">
        ...
        <input class="form-control" name="product-code" value="{{ $product->product_code }}" type="text">
      </div>
      <div class="form-group col-md-12">
        <label for="product sku">Product SKU</label>
        <input class="form-control" name="product-sku" value="{{ $product->product_sku }}" type="text" required>
      </div>
      <div class="form-group col-md-12">
        <label for="pirce">Product Price</label>
        <input class="form-control text-left" data-inputmask="'alias': 'currency'" value="{{ $product->price }}" name="price" required>
      </div>
      <div class="form-group col-md-12">
        <label for="discount pirce">Discount Price</label>
        <input class="form-control text-left" data-inputmask="'alias': 'currency'" value="{{ $product->discount_price }}" name="discount-price">
      </div>
      <div class="form-group col-md-12">
        <label for="discount pirce">Shipping Price</label>
        <input class="form-control text-left" data-inputmask="'alias': 'currency'" value="{{ $product->discount_price }}" name="shipping-price">
      </div>
      <div class="form-group col-md-12">
        <label for="product categories">Product Categories</label>
        @php $selectedCategories = explode("|", $product->categories); @endphp
        <select class="js-example-basic-multiple w-100" name="product-categories[]" multiple="multiple">
      ...
      <div class="form-group col-md-12">
        ...
        <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target=".bd-image-modal-xl">CHANGE IMAGE</button>
        ...
        @else
            <img src="/media/{{ $product->featured_image }}" id="featured-view" class="img-responsive mt-2" alt="Image Not Selected" style="width: 100%;">
        @endif
        <input type="hidden" name="featured-image" value="{{ $product->featured_image }}" id="selected-featured">
      </div>
      <div class="form-group col-md-12">
        <label for="featured image">Image Gallery</label>
        <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target=".bd-image-modal-x2">CHANGE IMAGES</button>
        <input type="hidden" name="images-gallery" value="{{ $product->images_gallery }}" id="selected-multiple">
        @if(empty($product->images_gallery))
          <p id="count-multiple" class="mt-2 text-secondary">0 Images Selected</p>
        @else
          @php
            $imagesList = explode("|", $product->images_gallery);
            $imagesList = array_filter($imagesList);
          @endphp
          @foreach ($imagesList as $image)
            <img src="/media/{{ $image }}" style="width: 60px; margin: 5px; margin-left: 0;">
          @endforeach
        @endif
      </div>
      <div class="form-group col-md-12">
        <label for="featured image">Product Label</label>
         @php
            ...
            if($product->label == "new"):
                $new = "checked";
            elseif($product->label == "sale"):
                $featured = "checked";
            elseif($product->label == "featured"):
                $featured = "checked";
            elseif($product->label == "top-seller"):
                $topSeller = "checked";
            endif;
        @endphp
        <div class="form-group">
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="label" id="optionsRadios1" value="new" {{$new}}>
              New
            <i class="input-frame"></i></label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="label" id="optionsRadios2" value="sale" {{$sale}}>
              Sale
            <i class="input-frame"></i></label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="label" id="optionsRadios3" value="featured" {{$featured}}>
              Featured
            <i class="input-frame"></i></label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="label" id="optionsRadios4" value="top-seller" {{$topSeller}}>
              Top Seller
            <i class="input-frame"></i></label>
          </div>
        </div>
      ...
      <hr>
      <div class="form-group col-md-12">
        <button class="btn btn-primary btn-block" name="update">UPDATE PRODUCT</button>
