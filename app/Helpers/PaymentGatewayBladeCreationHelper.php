...
class PaymentGatewayBladeCreationHelper
{
    public static function createBraintreeBladeFile($isPayPalEnabled)
    {
        ...
        // Read File Not Working Methods
        // $brainTreeTemplate  = file_get_contents($paymentGatewayPath . 'templates/braintree-js-template.blade.php');
        
        // Read File Working Method
        $brainTreeTemplate = File::get(base_path($paymentGatewayPath . 'templates/braintree-js-template.blade.php'));
    ...
    public static function createPaypalSmartBladeFile()
    {
        ...
        // Read File Working Methods
        $payPalTemplate = File::get(base_path($payPalPath . 'templates/paypal-smart-js-template.blade.php'));
